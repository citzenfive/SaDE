...
An example `main.py` is shown below.
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SaDE optimization."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Random seed. A system-generated seed is used when omitted.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="Strategy learning period. Default: 50.",
    )
...
def main() -> None:
    ...
    print(f"Best individual: {list(best)}")
